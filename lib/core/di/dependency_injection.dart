...
//       () => RemoteProductCatalogDataSource(inject<ApiService>()),
//     )
...
//       ),
//     )
//     ..registerFactory<ReadSyncBloc>(() => ReadSyncBloc(
//           syncService: inject<SyncService>(),
//           connection: inject<ConnectivityService>(),
//           // syncService: inject<SyncService>(),
//           // networkService: inject<NetworkService>(),
//         ))
//     ..registerFactory<WriteSyncBloc>(() => WriteSyncBloc(
//           syncService: inject<SyncService>(),
//           connection: inject<ConnectivityService>(),
//           // syncService: inject<SyncService>(),
//           // networkService: inject<NetworkService>(),
...
//       () => TaxApiService(inject<ApiService>()),
//     )
...
//       () => BranchApiService(inject<ApiService>()),
//     )
...
//       () => RegisterApiService(inject<ApiService>()),
//     )
...
//       () => RegisterShiftRemoteDataSource(inject<ApiService>()),
//     )
...
//       () => ReceiptTemplateApiService(inject<ApiService>()),
//     )
...
//       () => PurchaseOrderApi(inject<ApiService>()),
//     )
...
//       () => TransactionApi(inject<ApiService>()),
//     )
...
//       () => RemoteSaleDataSource(inject<ApiService>()),
//     )
...
//       () => RemoteRefundDataSource(inject<ApiService>()),
//     )
...
//         ..registerFactory(() => NewPurchaseOrderFormCubit())
