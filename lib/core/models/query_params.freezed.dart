...
abstract class $FilterQueryCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? search, Map<String, dynamic>? extra});
}
...
abstract class _$$FilterQueryImplCopyWith<$Res>
  ...
  factory _$$FilterQueryImplCopyWith(
          _$FilterQueryImpl value, $Res Function(_$FilterQueryImpl) then) =
...
class __$$FilterQueryImplCopyWithImpl<$Res>
  ...
  __$$FilterQueryImplCopyWithImpl(
      _$FilterQueryImpl _value, $Res Function(_$FilterQueryImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$FilterQueryImpl(
      search: freezed == search
          ? _value.search
          : search // ignore: cast_nullable_to_non_nullable
              as String?,
...
class _$FilterQueryImpl implements _FilterQuery {
  const _$FilterQueryImpl({this.search, final Map<String, dynamic>? extra})
      : _extra = extra;
  ...
  @override
  String toString() {
    return 'FilterQuery(search: $search, extra: $extra)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, search, const DeepCollectionEquality().hash(_extra));
...
abstract class _FilterQuery implements FilterQuery {
  const factory _FilterQuery(
      {final String? search,
      final Map<String, dynamic>? extra}) = _$FilterQueryImpl;
