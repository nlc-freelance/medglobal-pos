...
class SearchDropdown<T> extends StatefulWidget {
  ...
  factory SearchDropdown.single({
    ...
    bool isLeftLabelInDialog = false,
    T? selectedItem,
  }) =>
      SearchDropdown._(
        ...
        isLeftLabelInDialog: isLeftLabelInDialog,
        itemAsString: itemAsString,
        asyncItemsCallback: asyncItemsCallback,
    ...
    return widget.isLeftLabel
        ? Row(
            children: [
                  ...
                  TextSpan(
                    ...
                    children: [
                      if (widget.isRequired)
                        TextSpan(
                          text: ' *',
                          style: UIStyleText.labelMedium.copyWith(color: UIColors.accent),
                        ),
                    ],
                  ),
                ),
              ...
              if (!widget.isLeftLabelInDialog) const Spacer(flex: 3),
            ],
          )
        : Column(
            ...
            children: [
              Text.rich(
                TextSpan(
                  text: widget.label,
                  style: UIStyleText.labelRegular,
                  children: [
                    if (widget.isRequired)
                      TextSpan(
                        text: ' *',
                        style: UIStyleText.labelRegular.copyWith(color: UIColors.accent),
                      ),
                  ],
                ),
              ),
