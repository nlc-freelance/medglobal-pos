            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  const Spacer(),
                  CancelActionButton(
                    onCancel: () => AppRouter.router.pushReplacementNamed(SideMenuTreeItem.products.name),
                    ...
                    onAction: () {
                      if (_formKey.currentState?.validate() == true) {
                        ...
                        if (initialProduct?.variants == null || initialProduct?.variants?.first.name == 'default') {
