...
class CreateStockReturnUseCase implements UseCase<StockReturn, CreateStockReturnParams> {
  ...
  @override
  Future<Either<Failure, StockReturn>> call(CreateStockReturnParams params) =>
      repository.create(params.stockReturnRequest);
}

class CreateStockReturnParams {
  final StockReturnRequest stockReturnRequest;

  CreateStockReturnParams(this.stockReturnRequest);
}
