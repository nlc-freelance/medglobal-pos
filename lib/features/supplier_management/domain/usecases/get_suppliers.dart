...
class GetSuppliersUseCase implements UseCase<SupplierList, GetSuppliersParams> {
  final SupplierRepository repository;

  const GetSuppliersUseCase(this.repository);

  @override
  Future<Either<Failure, SupplierList>> call(GetSuppliersParams params) => repository.getSuppliers(params.page);
}
