...
abstract class $BranchInventoryDtoCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, BranchLiteDto store, double price, int currentStock});
...
/// @nodoc
@JsonSerializable()
class _$BranchInventoryDtoImpl extends _BranchInventoryDto {
...
abstract class _BranchInventoryDto extends BranchInventoryDto {
  ...
  const _BranchInventoryDto._() : super._();
