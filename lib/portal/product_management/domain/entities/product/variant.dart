...
class Variant with _$Variant {
  ...
  List<BranchLite> getAllBranches() {
    List<BranchLite> allBranches = [];
    for (var branchInventory in branchInventories) {
  ...
  DataGridRow toDataGridRow() => DataGridRow(
        cells: [
          ...
          DataGridCell<List<String>>(
            columnName: 'branches',
            value: branchInventories.map((inventory) => inventory.branch.name).toList(),
          ),
          DataGridCell<List<String>>(
            columnName: 'suppliers',
            value: suppliers.map((supplier) => supplier.name).toList(),
          ),
...
@freezed
class VariantLite with _$VariantLite {
  const factory VariantLite({
    required int id,
...
@freezed
class VariantPartial with _$VariantPartial {
  const factory VariantPartial({
    int? id,
    String? name,
    String? sku,
    String? displayName,
