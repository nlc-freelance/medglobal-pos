...
abstract class ReportRepository {
  ...
  Future<ApiResult<Report>> createReport(ReportPayload payload);

  /// Retrieves a list of reports that match the query.
  Future<ApiResult<PaginatedList<Report>>> getReports(PageQuery query);

  /// Retrieves a specific report by its [id].
  Future<ApiResult<Report>> getReport(int id);
