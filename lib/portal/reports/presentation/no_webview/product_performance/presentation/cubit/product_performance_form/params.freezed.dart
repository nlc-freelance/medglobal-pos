...
abstract class $ProductPNLParamsCopyWith<$Res> {
  ...
  @useResult
  $Res call({Branch? branch, List<Category>? categories, int? topN});
...
class _$ProductPNLParamsImpl implements _ProductPNLParams {
  const _$ProductPNLParamsImpl(
      {this.branch, final List<Category>? categories, this.topN})
  ...
  @override
  String toString() {
    return 'ProductPNLParams(branch: $branch, categories: $categories, topN: $topN)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, branch,
      const DeepCollectionEquality().hash(_categories), topN);
