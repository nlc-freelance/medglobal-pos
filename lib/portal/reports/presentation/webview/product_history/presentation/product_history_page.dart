        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              AppDropdown<BranchPartial>.lazy(
                hasInlineLabel: true,
                inlineLabel: 'Branch',
                hint: 'Select branch',
                getName: (branch) => branch.name,
                onSelectItem: (branch) => context.read<ProductHistoryListFilterCubit>().setBranchId(branch.id),
                onRemoveSelectedItem: () => context.read<ProductHistoryListFilterCubit>().setBranchId(null),
              ...
              DatePickerPopup(
                ...
                onSelect: (date) {
                  ...
                  context.read<ProductHistoryListFilterCubit>().setStartDate(date.toFormattedShortDate());
                },
                onRemoveSelected: () {
              ...
              const UIHorizontalSpace(12),
              BlocBuilder<ProductHistoryListFilterCubit, ProductHistoryListFilterState>(
                      ...
                      ? Expanded(
                          child: Row(
                            ...
                            children: [
                              ...
                              // const Spacer(),
                              ExportButton(
                                type: ReportType.productHistory,
                                filters: {
                                  'variantId': state.variantId,
                                  'startDate': state.startDate,
                                  'branchId': state.branchId,
              ...
              // if (context.read<ProductHistoryListFilterCubit>().state.isValid)
              //   UIButton.filled(
              //     'Search',
              //     onClick: () => context.read<ProductHistoryListCubit>().getProductHistory(
          ...
          //     return state.isValid
          //         ? const SizedBox.shrink()
          //         : UIText.labelMedium('Product, branch, and date are required.', color: UIColors.error);
          //   },
          // ),
