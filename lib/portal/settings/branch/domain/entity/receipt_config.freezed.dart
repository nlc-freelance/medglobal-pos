...
ReceiptConfig _$ReceiptConfigFromJson(Map<String, dynamic> json) {
  return _ReceiptConfig.fromJson(json);
}

/// @nodoc
mixin _$ReceiptConfig {
  ...
  @JsonKey(ignore: true)
  $ReceiptConfigCopyWith<ReceiptConfig> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ReceiptConfigCopyWith<$Res> {
  factory $ReceiptConfigCopyWith(
          ReceiptConfig value, $Res Function(ReceiptConfig) then) =
      _$ReceiptConfigCopyWithImpl<$Res, ReceiptConfig>;
  @useResult
  $Res call(
      {int id,
      int accountId,
...
/// @nodoc
class _$ReceiptConfigCopyWithImpl<$Res, $Val extends ReceiptConfig>
    implements $ReceiptConfigCopyWith<$Res> {
  _$ReceiptConfigCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$ReceiptConfigImplCopyWith<$Res>
    implements $ReceiptConfigCopyWith<$Res> {
  factory _$$ReceiptConfigImplCopyWith(
          _$ReceiptConfigImpl value, $Res Function(_$ReceiptConfigImpl) then) =
      __$$ReceiptConfigImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {int id,
...
/// @nodoc
class __$$ReceiptConfigImplCopyWithImpl<$Res>
    extends _$ReceiptConfigCopyWithImpl<$Res, _$ReceiptConfigImpl>
    implements _$$ReceiptConfigImplCopyWith<$Res> {
  __$$ReceiptConfigImplCopyWithImpl(
      _$ReceiptConfigImpl _value, $Res Function(_$ReceiptConfigImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$ReceiptConfigImpl(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int,
...
/// @nodoc
@JsonSerializable()
class _$ReceiptConfigImpl implements _ReceiptConfig {
  const _$ReceiptConfigImpl(
      {required this.id,
  ...
  factory _$ReceiptConfigImpl.fromJson(Map<String, dynamic> json) =>
      _$$ReceiptConfigImplFromJson(json);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$ReceiptConfigImplCopyWith<_$ReceiptConfigImpl> get copyWith =>
      __$$ReceiptConfigImplCopyWithImpl<_$ReceiptConfigImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$ReceiptConfigImplToJson(
      this,
    );
  }
}

abstract class _ReceiptConfig implements ReceiptConfig {
  const factory _ReceiptConfig(
      ...
      final String? branchAddress,
      final String? branchPhone,
      final String? branchEmail}) = _$ReceiptConfigImpl;

  factory _ReceiptConfig.fromJson(Map<String, dynamic> json) =
      _$ReceiptConfigImpl.fromJson;
