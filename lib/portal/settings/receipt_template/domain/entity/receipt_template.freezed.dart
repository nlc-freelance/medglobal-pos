...
/// @nodoc
abstract class $ReceiptTemplateCopyWith<$Res> {
  factory $ReceiptTemplateCopyWith(
          ReceiptTemplate value, $Res Function(ReceiptTemplate) then) =
      _$ReceiptTemplateCopyWithImpl<$Res, ReceiptTemplate>;
  @useResult
  $Res call(
      {int? id,
      int accountId,
...
/// @nodoc
class _$ReceiptTemplateCopyWithImpl<$Res, $Val extends ReceiptTemplate>
    implements $ReceiptTemplateCopyWith<$Res> {
  _$ReceiptTemplateCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$ReceiptTemplateImplCopyWith<$Res>
    implements $ReceiptTemplateCopyWith<$Res> {
  factory _$$ReceiptTemplateImplCopyWith(_$ReceiptTemplateImpl value,
          $Res Function(_$ReceiptTemplateImpl) then) =
      __$$ReceiptTemplateImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {int? id,
...
/// @nodoc
class __$$ReceiptTemplateImplCopyWithImpl<$Res>
    extends _$ReceiptTemplateCopyWithImpl<$Res, _$ReceiptTemplateImpl>
    implements _$$ReceiptTemplateImplCopyWith<$Res> {
  __$$ReceiptTemplateImplCopyWithImpl(
      _$ReceiptTemplateImpl _value, $Res Function(_$ReceiptTemplateImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$ReceiptTemplateImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
