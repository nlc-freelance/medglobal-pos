...
class _$PurchaseOrderItemImpl extends _PurchaseOrderItem {
  ...
  @override
  String toString() {
    return 'PurchaseOrderItem(id: $id, variantId: $variantId, name: $name, sku: $sku, quantityOnHand: $quantityOnHand, quantityOrdered: $quantityOrdered, quantityReceived: $quantityReceived, supplierPrice: $supplierPrice, sellingPrice: $sellingPrice, total: $total)';
  }
