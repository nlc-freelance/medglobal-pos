...
//             if (purchaseOrder.status == StockOrderStatus.NEW) const PurchaseOrderItemsDataGrid(),
//             if (purchaseOrder.status == StockOrderStatus.FOR_RECEIVING) const PurchaseOrderReceivingItemsDataGrid(),
//             if (purchaseOrder.status == StockOrderStatus.COMPLETED ||
//                 purchaseOrder.status == StockOrderStatus.CANCELLED)
//               const PurchaseOrderReceivedItemsDataGrid(),
