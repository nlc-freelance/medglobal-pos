...
//             final payload = context.select((NewPurchaseOrderFormCubit cubit) => cubit.state.newPurchaseOrder);
//
...
//                   ),
//                   updated: (po) {
//                     context.read<PurchaseOrderFormCubit>().loadPurchaseOrder(po);
//                     setState(() {
//                       if (po.status == StockOrderStatus.NEW) {
//                         _currentStep = 1;
//                       } else if (po.status == StockOrderStatus.FOR_RECEIVING) {
//                         _currentStep = 2;
//                       } else if (po.status == StockOrderStatus.COMPLETED || po.status == StockOrderStatus.CANCELLED) {
//                         _currentStep = 3;
//                       }
//                     });
//                   },
...
//                   ? Theme(data: Theme.of(context), child: const PurchaseOrderCreateForm())
//                   : const SizedBox(),
//             ),
//             Step(
