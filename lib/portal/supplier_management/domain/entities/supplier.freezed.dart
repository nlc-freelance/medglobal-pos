...
class _$SupplierImpl extends _Supplier {
  ...
  @override
  String toString() {
    return 'Supplier(id: $id, name: $name, mainContactName: $mainContactName, email: $email, phone: $phone, fax: $fax, website: $website, street1: $street1, street2: $street2, city: $city, state: $state, zipCode: $zipCode, country: $country, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
