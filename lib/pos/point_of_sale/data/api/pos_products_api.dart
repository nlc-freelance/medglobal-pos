...
abstract class POSProductApi {
  Future<POSProductPaginatedList> getPOSProducts({required int page, String? search, String? category});
}
...
class POSProductApiImpl implements POSProductApi {
  ...
  @override
  Future<POSProductPaginatedList> getPOSProducts({required int page, String? search, String? category}) async {
    try {
