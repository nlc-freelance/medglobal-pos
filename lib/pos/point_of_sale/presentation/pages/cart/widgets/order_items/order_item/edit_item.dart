...
class _EditItemState extends State<EditItem> {
  ...
  void initState() {
    ...
    final item = (context.read<OrderBloc>().state.order.items ?? []).singleWhere((item) => item.id == widget.item.id);

    _qtyController = TextEditingController(text: item.quantity.toString());
              ...
              children: [
                  ...
                  child: Theme(
                    ...
                    child: UITextField.topLabel(
                      ...
                      onChanged: (value) => context.read<OrderBloc>().add(
                            OrderEvent.updateItemQuantity(item.quantity, _qtyController.text.toInt()!),
                            // onChanged: (value) => context.read<OrderBloc>().setQtyPerItem(
                            // id: item.id!,
                ...
                Expanded(
                  ...
                  child: UIDropdownButton<DiscountCategory>.topLabel(
                    hint: 'Add Discount',
                    label: 'Discount',
                    suffixIcon: item.discount != null
                        // suffixIcon: item.discountCategory != null
                        ? InkWell(
                            onTap: () => context.read<OrderBloc>().add(OrderEvent.removeItemDiscount(item.id)),
                            // onTap: () => context.read<OrderBloc>().removeDiscountPerItem(item.id!),
                    ...
                    onSelect: (category) {
                      context.read<OrderBloc>().add(OrderEvent.setItemDiscount(item.id, category));
                      // context.read<OrderBloc>().setDiscountPerItem(
                      //       id: item.id!,
