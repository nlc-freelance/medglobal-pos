...
class _POSProductsDataGridState extends State<POSProductsDataGrid> {
  ...
  late POSProductsDataSource _registerItemsDataSource;

  @override
  void initState() {
    super.initState();
    _dataGridController = DataGridController();
    _registerItemsDataSource = POSProductsDataSource(widget.items, context);
  }
    ...
    return BlocBuilder<RegisterShiftBloc, RegisterShiftState>(
      builder: (context, _) => FutureBuilder(
          ...
          builder: (context, snapshot) {
            return BlocConsumer<POSProductListRemoteCubit, POSProductListRemoteState>(
                            ...
                            ? Padding(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    context.read<ProductSearchCubit>().state.search != null
                                        ? UIText.labelMedium(
                                            'No results found for \'${context.read<ProductSearchCubit>().state.search}\'')
...
class POSProductsDataSource extends DataGridSource {
  ...
  Future<void> handleLoadMoreRows() async {
    final search = _context.read<ProductSearchCubit>().state.search;
    _context.read<POSProductListRemoteCubit>().getPOSProducts(search: search);
  }
