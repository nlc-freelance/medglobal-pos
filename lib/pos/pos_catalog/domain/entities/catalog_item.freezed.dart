...
abstract class $CatalogItemCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String displayName, int stock, double price});
}
...
class _$CatalogItemImpl implements _CatalogItem {
  ...
  @override
  String toString() {
    return 'CatalogItem(id: $id, displayName: $displayName, stock: $stock, price: $price)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, id, displayName, stock, price);
...
abstract class _CatalogItem implements CatalogItem {
  const factory _CatalogItem(
      ...
      required final double price}) = _$CatalogItemImpl;
