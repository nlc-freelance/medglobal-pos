...
// part 'product_catalog_bloc.freezed.dart';
//
...
//
//         result.when(
//           success: (_) => emit(ProductCatalogRemoteState.synced(DateTime.now())),
//           failure: (failure) => emit(ProductCatalogRemoteState.failure(failure.message)),
//         );
//       } else {
