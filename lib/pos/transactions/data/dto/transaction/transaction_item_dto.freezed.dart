...
// double? discount,
  ...
  @override
  String toString() {
    return 'TransactionItemDto(id: $id, variant: $variant, quantity: $quantity, price: $price, discount: $discount, discountType: $discountType, discountInPeso: $discountInPeso, subTotal: $subTotal, total: $total, comment: $comment, restockQuantity: $restockQuantity, writeOffQuantity: $writeOffQuantity)';
  }
