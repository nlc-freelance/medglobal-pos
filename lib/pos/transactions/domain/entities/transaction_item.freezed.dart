...
class _$TransactionItemImpl extends _TransactionItem {
  ...
  @override
  String toString() {
    return 'TransactionItem(id: $id, itemId: $itemId, name: $name, sku: $sku, price: $price, quantity: $quantity, discountType: $discountType, discount: $discount, discountAmount: $discountAmount, subtotal: $subtotal, total: $total, comment: $comment, restockQty: $restockQty, writeOffQty: $writeOffQty)';
  }
