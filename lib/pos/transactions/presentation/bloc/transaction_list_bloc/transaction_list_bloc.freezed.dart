...
mixin _$TransactionListEvent {
  ...
  TResult when<TResult extends Object?>({
    required TResult Function(String? search, dynamic forceRefresh) fetch,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    TResult? Function(String? search, dynamic forceRefresh)? fetch,
...
abstract class _$$FetchImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? search, dynamic forceRefresh});
}
    ...
    return _then(_$FetchImpl(
      search: freezed == search
          ...
          : search // ignore: cast_nullable_to_non_nullable
              as String?,
      forceRefresh:
          freezed == forceRefresh ? _value.forceRefresh! : forceRefresh,
    ));
  }
}
...
class _$FetchImpl implements _Fetch {
  const _$FetchImpl({this.search, this.forceRefresh = false});
  ...
  @override
  String toString() {
    return 'TransactionListEvent.fetch(search: $search, forceRefresh: $forceRefresh)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, search, const DeepCollectionEquality().hash(forceRefresh));
  ...
  TResult when<TResult extends Object?>({
    ...
    return fetch(search, forceRefresh);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return fetch?.call(search, forceRefresh);
  }
...
abstract class _Fetch implements TransactionListEvent {
  const factory _Fetch({final String? search, final dynamic forceRefresh}) =
      _$FetchImpl;
