  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider(create: (_) => GetIt.I<ReadSyncBloc>()),
        BlocProvider(create: (_) => GetIt.I<WriteSyncBloc>()),
            ...
            listener: (context, state) {
              ...
              state.maybeWhen(
                ready: (_) {
                  ...
                  context.read<ReadSyncBloc>().add(const ReadSyncEvent.start());
                  context.read<WriteSyncBloc>().add(const WriteSyncEvent.start());
                },
                orElse: () => {},
              );
            },
